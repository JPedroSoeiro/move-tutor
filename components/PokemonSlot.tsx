      ...
      {pokemon && (
        <div className="animate-in fade-in slide-in-from-bottom-2 duration-500 space-y-4">
          ...
          <div className="flex gap-3 items-start">
            {/* SPRITE - LEFT */}
            <div className="relative w-32 h-32 rounded-2xl bg-gradient-to-b from-white/10 via-white/5 to-zinc-900/50 border border-white/10 overflow-hidden flex items-center justify-center shadow-lg p-2 flex-shrink-0">
              <img
                src={spritePath}
                alt={pokemon.name}
            ...
            <div className="flex flex-col gap-2 flex-1 min-w-0">
              ...
              <div className="flex items-center justify-between gap-2">
                <h3 className="text-base font-black text-white uppercase tracking-tighter truncate">{pokemon.name}</h3>
                ...
                <div className="flex gap-1.5 shrink-0">
                  ...
                  <button
                    ...
                    className={`p-1 rounded-lg transition-all border text-xs ${isShiny ? "bg-yellow-400 text-black border-yellow-300" : "bg-zinc-800/80 text-white border-white/10 hover:border-yellow-400/50 hover:bg-zinc-700"}`}
                  ...
                  <div className="relative group/stats">
                    <button
                      ...
                      className="p-1 text-white bg-zinc-800/80 border border-white/10 rounded-lg hover:border-blue-500/50 hover:bg-blue-500/20 transition-all text-xs"
                  ...
                  {evolutions.length > 1 && (
                    <div className="relative">
                      <button
                        ...
                        className="p-1 text-blue-400 hover:text-blue-300 bg-zinc-800/50 border border-blue-500/30 rounded-lg hover:border-blue-500/50 transition-colors text-xs"
                        title="Evoluções"
                      >
              ...
              {/* TYPES - VERTICAL COLUMN */}
              <div className="flex flex-col gap-1.5">
                {pokemon.types.map((t) => (
                  <span
                    key={t.type.name}
                    className={`text-[7.5px] font-black uppercase px-3 py-1 rounded-full text-white w-fit ${TYPE_COLORS[t.type.name]} border border-white/20`}
                  >
                    {t.type.name}
                  </span>
                ))}
